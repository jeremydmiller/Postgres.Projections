...
exports.seedAll = function(options){
	...
	var operations = [
		...
		loadModule('/stream-aggregator.js', 'stream-aggregator'),
		loadModule('/event-projector.js', 'event-projector'),
		loadModule('/aggregate-projector.js', 'aggregate-projector'),
		projectionLoader.seedAllTables,
		projectionLoader.loadAllProjections,
		initialize
	];

	_.each(projectionLoader.projectionFiles)
